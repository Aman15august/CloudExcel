                ...
                <div className="row g-4 portfolio-container">
                    <div className="col-lg-4 col-md-6 portfolio-item first wow zoomIn" data-wow-delay="0.1s">
                        <div className="position-relative rounded overflow-hidden">
                            <Image className="img-fluid w-100" src="/images/project-1.jpg" alt="Responsive Image" width="350px" height="300px" />
                            <div className="portfolio-overlay">
                                <a className="btn btn-light" href="images/project-1.jpg" data-lightbox="portfolio"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-plus-square-fill" viewBox="0 0 16 16">
